...
game_images = {}
framepersecond = 32
pipeimage = (resource_path('pipe.png'))
background_image = (resource_path('background.jpg'))
birdplayer_image = (resource_path('bird.png'))
sealevel_image = (resource_path('base.jfif'))
...
if __name__ == "__main__":
	...
	game_images['scoreimages'] = (
		pygame.image.load(resource_path('0.png')).convert_alpha(),
		pygame.image.load(resource_path('1.png')).convert_alpha(),
		pygame.image.load(resource_path('2.png')).convert_alpha(),
		pygame.image.load(resource_path('3.png')).convert_alpha(),
		pygame.image.load(resource_path('4.png')).convert_alpha(),
		pygame.image.load(resource_path('5.png')).convert_alpha(),
		pygame.image.load(resource_path('6.png')).convert_alpha(),
		pygame.image.load(resource_path('7.png')).convert_alpha(),
		pygame.image.load(resource_path('8.png')).convert_alpha(),
		pygame.image.load(resource_path('9.png')).convert_alpha()
	)
